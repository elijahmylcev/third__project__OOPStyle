...
/* harmony import */ var _modules_slider_slider_mini__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/slider/slider-mini */ "./src/js/modules/slider/slider-mini.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  slider.render();
  var modulePageSlider = new _modules_slider_slider_main__WEBPACK_IMPORTED_MODULE_3__["default"]({
    container: '.moduleapp',
    buttons: '.next'
  });
  modulePageSlider.render();
  var player = new _modules_playVideo__WEBPACK_IMPORTED_MODULE_2__["default"]('.showup .play', '.overlay', '.close');
  player.init();
  ...
  modulesSlider.init();
  var feedSlider = new _modules_slider_slider_mini__WEBPACK_IMPORTED_MODULE_4__["default"]({
    ...
    value: function init() {
      ...
      this.forms.forEach(function (form) {
        form.addEventListener('submit', function (e) {
          e.preventDefault(); // form animated
...
/*#__PURE__*/
function () {
  function VideoPlayer(triggers, overlay, close) {
...
function (_Slider) {
  ...
  function MainSlider(buttons) {
    _classCallCheck(this, MainSlider);

    return _possibleConstructorReturn(this, _getPrototypeOf(MainSlider).call(this, buttons));
  }
