...
window.addEventListener('DOMContentLoaded', function () {
  ...
  slider.render();
  var player = new _modules_playVideo__WEBPACK_IMPORTED_MODULE_0__["default"]('.showup .play', '.overlay', '.close');
  player.init();
});
...
function (_Slider) {
  ...
  function MainSlider(page, buttons) {
    _classCallCheck(this, MainSlider);

    return _possibleConstructorReturn(this, _getPrototypeOf(MainSlider).call(this, page, buttons));
  }
